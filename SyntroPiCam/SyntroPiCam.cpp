...
void SyntroPiCam::cameraState(QString state)
{
	m_cameraState = state;
}

void SyntroPiCam::audioState(QString state)
{
	m_audioState = state;
}

void SyntroPiCam::videoFormat(int width, int height, int /* frameRate */)
{
	m_imgSize.setWidth(width);
	m_imgSize.setHeight(height);
}

void SyntroPiCam::newJPEG(QByteArray frame)
{
	m_frameCount++;
...
void SyntroPiCam::timerEvent(QTimerEvent *event)
{
...
void SyntroPiCam::processFrameQueue()
{
	QByteArray frame;
	QImage img;
...
void SyntroPiCam::showJPEG(QByteArray frame)
{  
	if (frame.size() > 0) {
		QImage img;
...
void SyntroPiCam::showImage(QImage img)
{
	if (img.isNull())
		return;
...
void SyntroPiCam::layoutStatusBar()
{
...
void SyntroPiCam::saveWindowState()
{
...
void SyntroPiCam::restoreWindowState()
{
    QSettings *settings = SyntroUtils::getSettings();
...
void SyntroPiCam::onAbout()
{
    SyntroAbout dlg(this);
    dlg.exec();
}

void SyntroPiCam::onBasicSetup()
{
    BasicSetupDlg dlg(this);
    dlg.exec();
}

void SyntroPiCam::onConfigureStreams()
{
    StreamsDlg dlg(this);
...
void SyntroPiCam::onConfigureMotion()
{
    MotionDlg dlg(this);
...
void SyntroPiCam::onConfigureCamera()
{
    CameraDlg dlg(this);
...
void SyntroPiCam::onConfigureAudio()
{
    AudioDlg dlg(this);
